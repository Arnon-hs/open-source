...
`ai-agents` `docker` `fastapi` `multi-tenant` `nextjs` `open-source` `self-hosted` `whatsapp` `white-label`

## 🎯 Categories

self-hosting · multi-tenant · WhatsApp · AI agents · agencies · OpenAI · Anthropic · Docker · PostgreSQL
...
**Value:** sarrazola/openlivery may be useful when its README and activity match a concrete workflow.
...
<sub>🔭 Discovered 2026-09-07 · [View on GitHub](https://github.com/sarrazola/openlivery) · [← Back to Self-hosting](./README.md)</sub>
