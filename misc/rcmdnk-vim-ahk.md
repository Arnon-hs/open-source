...
`ahk` `autohotkey` `ime` `vim` `vim-mode` `windows`
...
**Value:** rcmdnk/vim_ahk may be useful when its README and activity match a concrete workflow.
...
<sub>🔭 Discovered 2026-05-07 · [View on GitHub](https://github.com/rcmdnk/vim_ahk) · [← Back to Misc](./README.md)</sub>
