...
GNU IFUNC is the real culprit behind CVE-2024-3094：GNU IFUNC is the real culprit behind CVE-2024-3094 may be useful when its README and activity match a concrete workflow.。适合用于Misc。Early or unclear: treat as research material until maintenance, releases, docs, and issue activity are verified.
...
<sub>🔭 Discovered 2026-05-08 · [View on GitHub](https://github.com/robertdfrench/ifuncd-up) · [← Back to Misc](./README.md)</sub>
