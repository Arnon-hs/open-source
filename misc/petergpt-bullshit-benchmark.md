...
**BullshitBench** – открытый набор тестов, разработанный Питером Гостевым для оценки способности AI‑моделей распознавать бессмысленные запросы и отвергать их, а не давать уверенные, но ошибочные ответы. Проект помогает измерять «критичность» моделей к нелогичным или вводящим в заблуждение промптам, способствуя более надёжному и безопасному использованию генеративных систем. Категория: AI/ML.

### 中文

petergpt/bullshit-benchmark：petergpt/bullshit-benchmark may be useful when its README and activity match a concrete workflow.。适合用于Misc。Early or unclear: treat as research material until maintenance, releases, docs, and issue activity are verified.

## 🧭 Practical evaluation

**Value:** petergpt/bullshit-benchmark may be useful when its README and activity match a concrete workflow.
...
<sub>🔭 Discovered 2026-05-09 · [View on GitHub](https://github.com/petergpt/bullshit-benchmark) · [← Back to Misc](./README.md)</sub>
