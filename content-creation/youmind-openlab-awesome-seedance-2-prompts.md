...
`ai-video` `awesome` `awesome-list` `prompt-engineering` `seedance` `seedance-2` `seedance-api` `seedance2` `video-generation` `video-prompt`

## 🎯 Categories

Content Creation · AI/ML · Backend · Marketing
...
YouMind-OpenLab/awesome-seedance-2-prompts：YouMind-OpenLab/awesome-seedance-2-prompts helps creators research, generate, repurpose, and publish content with less manual work.。适合用于research and produce content、repurpose assets across channels。Medium: useful for prototypes or internal workflows, with dependency and maintenance checks before production.

## 🧭 Practical evaluation

**Value:** YouMind-OpenLab/awesome-seedance-2-prompts helps creators research, generate, repurpose, and publish content with less manual work.
...
<sub>🔭 Discovered 2026-05-10 · [View on GitHub](https://github.com/YouMind-OpenLab/awesome-seedance-2-prompts) · [← Back to Content-creation](./README.md)</sub>
