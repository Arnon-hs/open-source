...
> Autonomous bug bounty hunting framework for Claude Code — 7-phase FSM, parallel hunter agents, 3-round adversarial verification, MCP control plane. Speed-tunable harness modes (fast/ultra/loop/plan).
...
<sub>🔭 Discovered 2026-05-04 · [View on GitHub](https://github.com/deonmenezes/bountyhunter) · [← Back to AI/ML](./README.md)</sub>
