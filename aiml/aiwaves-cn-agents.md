...
Проект aiwaves-cn/agents представляет собой набор агентов для обучения и применения искусственного интеллекта и машинного обучения. Он включает в себя различные агенты, разработанные с использованием различных алгоритмов и технологий AI/ML, что делает его ценным ресурсом для исследователей и разработчиков в этой области. Проект находится в списке awesome-ai-agents и доступен для использования и модификации.

### 中文

aiwaves-cn/agents：aiwaves-cn/agents helps add AI capability without starting from a blank model stack.。适合用于prototype AI features、build RAG or agent workflows。Early or unclear: treat as research material until maintenance, releases, docs, and issue activity are verified.

## 🧭 Practical evaluation

**Value:** aiwaves-cn/agents helps add AI capability without starting from a blank model stack.
