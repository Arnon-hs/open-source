...
[![Stars](https://img.shields.io/github/stars/Unvanquished/Unvanquished?style=flat-square&color=yellow)](https://github.com/Unvanquished/Unvanquished/stargazers) [![Forks](https://img.shields.io/github/forks/Unvanquished/Unvanquished?style=flat-square&color=blue)](https://github.com/Unvanquished/Unvanquished/network) [![Language](https://img.shields.io/badge/lang-C%2B%2B-informational?style=flat-square)](#) [![Score](https://img.shields.io/badge/score-57%2F100-brightgreen?style=flat-square)](#)
...
`cpp` `fps-game` `game` `game-development` `glm` `idtech3` `librocket` `open-source` `open-source-game` `real-time-strategy` `rmlui` `rts-game`
...
Unvanquished/Unvanquished：Unvanquished/Unvanquished helps add AI capability without starting from a blank model stack.。适合用于prototype AI features、build RAG or agent workflows。Medium: useful for prototypes or internal workflows, with dependency and maintenance checks before production.
...
<sub>🔭 Discovered 2026-05-09 · [View on GitHub](https://github.com/Unvanquished/Unvanquished) · [← Back to AI/ML](./README.md)</sub>
