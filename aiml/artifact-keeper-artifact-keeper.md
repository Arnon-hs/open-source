...
**artifact-keeper/artifact-keeper** — это универсальный open‑source реестр артефактов, который может заменить Artifactory или Nexus без лишних затрат. Он поддерживает более 40 форматов пакетов, предоставляет встроенное сканирование безопасности, расширяемую архитектуру на WASM‑плагинах и возможность репликации на edge‑узлы, что делает его идеальным решением для DevOps, инфраструктурных и AI/ML проектов.

### 中文

artifact-keeper/artifact-keeper：artifact-keeper/artifact-keeper helps add AI capability without starting from a blank model stack.。适合用于prototype AI features、build RAG or agent workflows。High for an OSS candidate: recent activity, adoption, and ecosystem signals are strong enough for a serious pilot.

## 🧭 Practical evaluation

**Value:** artifact-keeper/artifact-keeper helps add AI capability without starting from a blank model stack.
