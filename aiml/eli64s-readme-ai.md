...
`agents` `ai` `ai-agents` `ai-documentation` `anthropic` `badge-generator` `cli` `developer-tools` `devtools` `documentation` `documentation-generator` `gemini`
...
**Value:** eli64s/readme-ai helps add AI capability without starting from a blank model stack.
...
<sub>🔭 Discovered 2026-07-04 · [View on GitHub](https://github.com/eli64s/readme-ai) · [← Back to AI/ML](./README.md)</sub>
