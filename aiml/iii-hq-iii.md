...
`agents` `ai` `api` `backend` `developer-tools` `engine` `genai` `javascript` `primitives` `python` `rust` `typescript`
...
**Value:** iii-hq/iii helps add AI capability without starting from a blank model stack.
...
<sub>🔭 Discovered 2026-07-07 · [View on GitHub](https://github.com/iii-hq/iii) · [← Back to AI/ML](./README.md)</sub>
