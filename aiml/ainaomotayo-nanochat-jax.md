...
**Value:** I Rebuilt Karpathy's NanoChat in JAX. Here's What XLA Gets Right and What It Gets Dead Wrong. helps add AI capability without starting from a blank model stack.
