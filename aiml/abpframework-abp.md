...
`abp` `angular` `architecture` `aspnet` `aspnet-core` `aspnetcore` `blazor` `c-sharp` `csharp` `domain-driven-design` `dotnet-core` `framework`
...
**Value:** abpframework/abp helps add AI capability without starting from a blank model stack.
...
<sub>🔭 Discovered 2026-05-07 · [View on GitHub](https://github.com/abpframework/abp) · [← Back to AI/ML](./README.md)</sub>
