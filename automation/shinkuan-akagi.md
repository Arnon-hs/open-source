...
**shinkuan/Akagi** — это open‑source платформа, позволяющая в реальном времени анализировать партии в популярных онлайн‑махангах (Majsoul, Tenhou, Riichi City, Amatsuki) с помощью пользовательских AI‑моделей и получать игровые рекомендации. В проект включён готовый пример — Mortal AI, демонстрирующий работу системы. Проект сочетает технологии AI/ML и интерактивный фронтенд для удобного взаимодействия с игроками.

### 中文

shinkuan/Akagi：shinkuan/Akagi helps remove repetitive manual operations from a workflow.。适合用于remove manual work、connect tools into repeatable flows。Early or unclear: treat as research material until maintenance, releases, docs, and issue activity are verified.

## 🧭 Practical evaluation

**Value:** shinkuan/Akagi helps remove repetitive manual operations from a workflow.
...
<sub>🔭 Discovered 2026-05-08 · [View on GitHub](https://github.com/shinkuan/Akagi) · [← Back to Automation](./README.md)</sub>
