...
**ClawBench** — открытый бенчмарк для оценки браузерных AI‑агентов, охватывающий 153 повседневных онлайн‑задачи на 144 реальных сайтах. В проекте реализована пятиуровневая система записи действий, сопоставление с DOM‑структурой и автоматическая оценка с помощью LLM‑судьи; текущий лидер набрал 33,3 % успешных решений. Проект относится к категориям AI/ML и Data.

### 中文

reacher-z/ClawBench：reacher-z/ClawBench helps remove repetitive manual operations from a workflow.。适合用于remove manual work、connect tools into repeatable flows。Early or unclear: treat as research material until maintenance, releases, docs, and issue activity are verified.

## 🧭 Practical evaluation

**Value:** reacher-z/ClawBench helps remove repetitive manual operations from a workflow.
...
<sub>🔭 Discovered 2026-05-08 · [View on GitHub](https://github.com/reacher-z/ClawBench) · [← Back to Automation](./README.md)</sub>
