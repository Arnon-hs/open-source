...
**joshft/correctless** — это open‑source‑инструмент, в котором генеративный агент пишет код, а отдельный агент проверяет его по спецификации, реализуя специфика‑ориентированное TDD, адверсариальное QA и динамический уровень строгости для Claude Code. Проект объединяет AI/ML, DevTools и Security, обеспечивая автоматический контроль качества и безопасность создаваемого кода без ручного ревью.

### 中文

joshft/correctless：joshft/correctless helps remove repetitive manual operations from a workflow.。适合用于remove manual work、connect tools into repeatable flows。Early or unclear: treat as research material until maintenance, releases, docs, and issue activity are verified.

## 🧭 Practical evaluation

**Value:** joshft/correctless helps remove repetitive manual operations from a workflow.
...
<sub>🔭 Discovered 2026-05-08 · [View on GitHub](https://github.com/joshft/correctless) · [← Back to Automation](./README.md)</sub>
