...
Frontend · Backend · Observability · DevOps/Infra · Security
...
Современная панель управления сервером, написанная на Rust (backend) и React (frontend), объединяющая в одном интерфейсе управление сайтами, базами данных, Docker‑приложениями, Git‑деплоем, почтой, DNS, мониторингом, резервными копиями и средствами безопасности. Открытый исходный код позволяет легко расширять функционал и интегрировать AI/ML‑модули. Подходит как для небольших проектов, так и для масштабных инфраструктур.

### 中文

ovexro/dockpanel：ovexro/dockpanel helps ship user-facing interfaces with less custom UI work.。适合用于build product UI faster、reuse interface components。Early or unclear: treat as research material until maintenance, releases, docs, and issue activity are verified.

## 🧭 Practical evaluation

**Value:** ovexro/dockpanel helps ship user-facing interfaces with less custom UI work.
...
<sub>🔭 Discovered 2026-05-10 · [View on GitHub](https://github.com/ovexro/dockpanel) · [← Back to Frontend](./README.md)</sub>
