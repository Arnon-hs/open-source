...
Cortex-AI is an open-source, high-performance trading engine for automated crypto arbitrage and peer-to-peer spread scanning. This cutting-edge system supports multiple chains, including TON, Solana, and Base, and features a multi-chain flash-loan and DEX-arbitrage system. Developed by Cortex, this AI-driven platform enables fast and efficient trading strategies.

---

<sub>🔭 Discovered 2026-04-27 · [View on GitHub](https://github.com/Cortex-AI-Software/crypto-arbitrage-bot-automated-trading) · [← Back to Crypto](./README.md)</sub>
