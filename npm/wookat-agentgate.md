...
`ai-agents` `claude` `cli` `cursor` `developer-tools` `github-action` `lockfile` `mcp` `mcp-security` `model-context-protocol` `sarif` `security`

## 🎯 Categories

npm · AI-agent · security · MCP · credential-theft · remote-execution · static-analysis · lockfile · CI
...
**Value:** wookat/agentgate may be useful when its README and activity match a concrete workflow.
...
<sub>🔭 Discovered 2026-09-06 · [View on GitHub](https://github.com/wookat/agentgate) · [← Back to Npm](./README.md)</sub>
