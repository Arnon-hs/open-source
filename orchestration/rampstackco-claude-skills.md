...
rampstackco/claude-skills — это набор открытых навыков для Claude, независимых от стека технологий, охватывающих весь жизненный цикл веб‑проекта: брендинг, дизайн, контент, SEO, разработку, операционную поддержку, рост и исследования. Инструменты позволяют автоматизировать построение, релиз, аудит и оптимизацию сайта, объединяя возможности оркестрации, AI/ML и фронтенда в единой платформе.

### 中文

rampstackco/claude-skills：rampstackco/claude-skills helps turn isolated prompts and tools into repeatable agent workflows.。适合用于coordinate multi-agent workflows、add tool-use pipelines。High for an OSS candidate: recent activity, adoption, and ecosystem signals are strong enough for a serious pilot.

## 🧭 Practical evaluation

**Value:** rampstackco/claude-skills helps turn isolated prompts and tools into repeatable agent workflows.
