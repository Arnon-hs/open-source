...
| Category | Projects | |
|---|---|---|
| 🤖 **AI/ML** | 2390 | [Browse →](./aiml/) |
| 📦 **Misc** | 1122 | [Browse →](./misc/) |
| 🎨 **Frontend** | 603 | [Browse →](./frontend/) |
| 🧩 **Orchestration** | 542 | [Browse →](./orchestration/) |
| 🔧 **DevTools** | 319 | [Browse →](./devtools/) |
| ⚙️ **Backend** | 299 | [Browse →](./backend/) |
