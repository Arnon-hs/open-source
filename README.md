...
| Category | Projects | |
|---|---|---|
| 🤖 **AI/ML** | 4885 | [Browse →](./aiml/) |
| 📦 **Misc** | 2515 | [Browse →](./misc/) |
| 🎨 **Frontend** | 1242 | [Browse →](./frontend/) |
| 🧩 **Orchestration** | 986 | [Browse →](./orchestration/) |
| ⚙️ **Backend** | 777 | [Browse →](./backend/) |
| 🔧 **DevTools** | 759 | [Browse →](./devtools/) |
| ⛓️ **Crypto** | 463 | [Browse →](./crypto/) |
