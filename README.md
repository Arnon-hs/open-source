...
| Category | Projects | |
|---|---|---|
| 🤖 **AI/ML** | 5183 | [Browse →](./aiml/) |
| 📦 **Misc** | 3150 | [Browse →](./misc/) |
| 🎨 **Frontend** | 1561 | [Browse →](./frontend/) |
| 🧩 **Orchestration** | 1363 | [Browse →](./orchestration/) |
| 🏷️ **Mcp** | 936 | [Browse →](./mcp/) |
| 🔧 **DevTools** | 860 | [Browse →](./devtools/) |
...
| 🏷️ **Database** | 299 | [Browse →](./database/) |
