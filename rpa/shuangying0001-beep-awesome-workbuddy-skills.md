...
`ai` `ai-agents` `automation` `llm` `productivity` `skill`

## 🎯 Categories

rpa · mouse-automation · bezier-curves · anti-detection · humanization · reusable-skill
...
**Value:** shuangying0001-beep/awesome-workbuddy-skills may be useful when its README and activity match a concrete workflow.
...
<sub>🔭 Discovered 2026-09-07 · [View on GitHub](https://github.com/shuangying0001-beep/awesome-workbuddy-skills) · [← Back to Rpa](./README.md)</sub>
