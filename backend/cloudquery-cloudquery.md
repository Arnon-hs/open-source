...
Backend · Data · DevOps/Infra · Security
...
CloudQuery — это open‑source платформа для построения конвейеров обработки конфигурационных и security‑данных из облаков. Она позволяет автоматически собирать инвентарь ресурсов, выполнять CSPM, FinOps и управление уязвимостями, извлекая информацию из AWS, Azure, GCP и более чем 70 других облачных и SaaS‑источников. Проект сочетает возможности backend‑аналитики и AI/ML с удобными frontend‑интерфейсами для визуализации и управления данными.

### 中文

cloudquery/cloudquery：cloudquery/cloudquery helps teams reuse service infrastructure instead of rebuilding common backend pieces.。适合用于ship API services faster、reuse backend infrastructure。Medium: useful for prototypes or internal workflows, with dependency and maintenance checks before production.

## 🧭 Practical evaluation

**Value:** cloudquery/cloudquery helps teams reuse service infrastructure instead of rebuilding common backend pieces.
...
<sub>🔭 Discovered 2026-05-09 · [View on GitHub](https://github.com/cloudquery/cloudquery) · [← Back to Backend](./README.md)</sub>
