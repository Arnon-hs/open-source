...
Backend · Observability · DevOps/Infra
...
odigos‑io/odigos — это open‑source решение для распределённого трассирования без изменения кода приложений. С помощью OpenTelemetry и eBPF проект позволяет мгновенно собирать метрики, логи и трейсы из любой инфраструктуры, упрощая мониторинг и отладку в DevOps/Infra среде.

### 中文

odigos-io/odigos：odigos-io/odigos helps make production behavior easier to inspect and debug.。适合用于monitor systems、debug production behavior。Medium: useful for prototypes or internal workflows, with dependency and maintenance checks before production.

## 🧭 Practical evaluation

**Value:** odigos-io/odigos helps make production behavior easier to inspect and debug.
...
<sub>🔭 Discovered 2026-05-10 · [View on GitHub](https://github.com/odigos-io/odigos) · [← Back to Backend](./README.md)</sub>
