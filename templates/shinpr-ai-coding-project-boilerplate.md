...
sh​inpr/ai-coding-project-boilerplate — это открытый шаблон на TypeScript, предназначенный для построения агентных рабочих потоков с Claude Code. Проект включает готовые суб‑агенты, механизмы инженерии контекста и встроенные проверки качества кода, упрощая оркестрацию AI‑подсистем и ускоряя разработку фронтенда. Он подходит для проектов в категориях Orchestration, AI/ML и Frontend.

### 中文

shinpr/ai-coding-project-boilerplate：shinpr/ai-coding-project-boilerplate helps teams reuse working workflows and production presets instead of rebuilding them.。适合用于start from reusable workflows、standardize production recipes。Early or unclear: treat as research material until maintenance, releases, docs, and issue activity are verified.

## 🧭 Practical evaluation

**Value:** shinpr/ai-coding-project-boilerplate helps teams reuse working workflows and production presets instead of rebuilding them.
...
<sub>🔭 Discovered 2026-05-10 · [View on GitHub](https://github.com/shinpr/ai-coding-project-boilerplate) · [← Back to Templates](./README.md)</sub>
