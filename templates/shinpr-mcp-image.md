...
MCP‑сервер shinpr/mcp-image предоставляет полностью открытый бекенд для генерации и редактирования изображений с помощью ИИ, автоматически оптимизируя подсказки и применяя предустановленные уровни качества. В качестве движка используется Gemini (Nano Banana 2 и Pro), а при необходимости можно подключить поддержку изображений от OpenAI GPT. Проект относится к оркестрации, AI/ML и серверной инфраструктуре.

### 中文

shinpr/mcp-image：shinpr/mcp-image helps teams reuse working workflows and production presets instead of rebuilding them.。适合用于start from reusable workflows、standardize production recipes。Early or unclear: treat as research material until maintenance, releases, docs, and issue activity are verified.

## 🧭 Practical evaluation

**Value:** shinpr/mcp-image helps teams reuse working workflows and production presets instead of rebuilding them.
...
<sub>🔭 Discovered 2026-05-09 · [View on GitHub](https://github.com/shinpr/mcp-image) · [← Back to Templates](./README.md)</sub>
