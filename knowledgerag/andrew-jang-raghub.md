...
RAGHub — это открытый репозиторий, собирающий лучшие фреймворки, проекты и материалы по Retrieval‑Augmented Generation (RAG) в одном месте. Сообщество может как добавлять новые инструменты, так и исследовать уже существующие, способствуя быстрому развитию экосистемы RAG. Проект ориентирован на разработчиков и исследователей в области AI/ML, желающих быстро находить и использовать проверенные решения.

### 中文

Andrew-Jang/RAGHub：Andrew-Jang/RAGHub helps make internal knowledge searchable and usable by assistants.。适合用于index knowledge bases、improve search over documents。Early or unclear: treat as research material until maintenance, releases, docs, and issue activity are verified.

## 🧭 Practical evaluation

**Value:** Andrew-Jang/RAGHub helps make internal knowledge searchable and usable by assistants.
...
<sub>🔭 Discovered 2026-05-10 · [View on GitHub](https://github.com/Andrew-Jang/RAGHub) · [← Back to Knowledgerag](./README.md)</sub>
