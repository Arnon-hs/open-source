...
local-first · persistent-memory · emotional-context · LLM-consultant · SQLite · legacy-hardware
...
**Value:** cleversonbrsantos-art/Phoenix may be useful when its README and activity match a concrete workflow.
...
<sub>🔭 Discovered 2026-09-09 · [View on GitHub](https://github.com/cleversonbrsantos-art/Phoenix) · [← Back to Local-first](./README.md)</sub>
