...
`fullstory` `hotjar` `logrocket` `recorder` `session-replay`

## 🎯 Categories

session-replay · tracing · debugging · OTEL · rrweb · syncline
...
**Value:** rrweb-io/rrweb may be useful when its README and activity match a concrete workflow.
...
<sub>🔭 Discovered 2026-09-10 · [View on GitHub](https://github.com/rrweb-io/rrweb) · [← Back to Session-replay](./README.md)</sub>
