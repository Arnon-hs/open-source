...
Проект **drhelius/Geargrafx** — кросс‑платформенный эмулятор и отладчик систем PC Engine / TurboGrafx‑16 / SuperGrafx / PCE CD‑ROM², включающий встроенный MCP‑сервер для удалённого управления. Он поддерживает macOS, Windows, Linux, BSD и может работать как ядро в RetroArch, предоставляя полную аппаратную совместимость и инструменты для разработки и отладки игр. Проект относится к категории Backend.

### 中文

drhelius/Geargrafx：drhelius/Geargrafx helps connect AI assistants to real tools and data through a standard protocol.。适合用于connect AI agents to tools、ship Model Context Protocol servers。Early or unclear: treat as research material until maintenance, releases, docs, and issue activity are verified.

## 🧭 Practical evaluation

**Value:** drhelius/Geargrafx helps connect AI assistants to real tools and data through a standard protocol.
...
<sub>🔭 Discovered 2026-05-09 · [View on GitHub](https://github.com/drhelius/Geargrafx) · [← Back to Mcp](./README.md)</sub>
