...
Teradata/teradata-mcp-server: open-source проект в категориях MCP, Backend, Data, Database. Практическое применение: connect AI agents to tools; ship Model Context Protocol servers. Уровень готовности: подходит для прототипа или внутреннего workflow, перед production нужна ручная проверка.
...
**Value:** Teradata/teradata-mcp-server helps connect AI assistants to real tools and data through a standard protocol.
...
<sub>🔭 Discovered 2026-08-20 · [View on GitHub](https://github.com/Teradata/teradata-mcp-server) · [← Back to Mcp](./README.md)</sub>
