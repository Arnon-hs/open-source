...
kreuzberg-dev/kreuzberg: kreuzberg-dev/kreuzberg helps connect AI assistants to real tools and data through a standard protocol.. Use it for connect AI agents to tools; ship Model Context Protocol servers. Medium: useful for prototypes or internal workflows, with dependency and maintenance checks before production.

### Русский

kreuzberg-dev/kreuzberg: open-source проект в категориях MCP, Knowledge/RAG, AI/ML, Backend. Практическое применение: connect AI agents to tools; ship Model Context Protocol servers. Уровень готовности: подходит для прототипа или внутреннего workflow, перед production нужна ручная проверка.
...
<sub>🔭 Discovered 2026-05-07 · [View on GitHub](https://github.com/kreuzberg-dev/kreuzberg) · [← Back to Mcp](./README.md)</sub>
