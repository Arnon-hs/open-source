...
`agent-tools` `ai-agents` `google-search` `google-search-api` `llm` `llm-tools` `mcp` `mcp-server` `metasearch` `model-context-protocol` `rag` `search-api`
...
**Value:** gefsikatsinelou/MetaSearchMCP helps connect AI assistants to real tools and data through a standard protocol.
...
<sub>🔭 Discovered 2026-05-08 · [View on GitHub](https://github.com/gefsikatsinelou/MetaSearchMCP) · [← Back to Mcp](./README.md)</sub>
