...
`ai-agents` `ai-memory` `claude` `claude-code` `cli` `codex` `coding-assistant` `developer-tools` `embeddings` `llm` `local-first` `mcp`
...
VonderVuflya/Yggdrasil: VonderVuflya/Yggdrasil helps connect AI assistants to real tools and data through a standard protocol.. Use it for connect AI agents to tools; ship Model Context Protocol servers. High for an OSS candidate: recent activity, adoption, and ecosystem signals are strong enough for a serious pilot.

### Русский

VonderVuflya/Yggdrasil: open-source проект в категориях MCP, Knowledge/RAG, AI/ML, DevTools, Data. Практическое применение: connect AI agents to tools; ship Model Context Protocol servers. Уровень готовности: готов для серьезного pilot с проверкой license, security и maintainer activity.
...
**Value:** VonderVuflya/Yggdrasil helps connect AI assistants to real tools and data through a standard protocol.
...
<sub>🔭 Discovered 2026-08-19 · [View on GitHub](https://github.com/VonderVuflya/Yggdrasil) · [← Back to Mcp](./README.md)</sub>
