...
**ramakay/claude-self-reflect** — небольшой open‑source пакет, устраняющий проблему «забывчивости» Claude: сохраняет контекст и позволяет модели помнить предыдущие реплики в ходе диалога. Плагин легко интегрируется через npm (`npm i claude-self-reflect`) и подходит для любых проектов, использующих Claude в качестве AI‑ассистента. Категория: AI/ML.

### 中文

ramakay/claude-self-reflect：ramakay/claude-self-reflect helps connect AI assistants to real tools and data through a standard protocol.。适合用于connect AI agents to tools、ship Model Context Protocol servers。Early or unclear: treat as research material until maintenance, releases, docs, and issue activity are verified.

## 🧭 Practical evaluation

**Value:** ramakay/claude-self-reflect helps connect AI assistants to real tools and data through a standard protocol.
...
<sub>🔭 Discovered 2026-05-08 · [View on GitHub](https://github.com/ramakay/claude-self-reflect) · [← Back to Mcp](./README.md)</sub>
