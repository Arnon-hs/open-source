...
**awizemann/scarf** — это нативное приложение для macOS и iOS, позволяющее работать с AI‑агентом Hermes в режиме нескольких окон и серверов (локального и удалённого по SSH). В интерфейсе объединены чат, дашборд, управление сессиями, память, планировщик cron, MCP и прочие инструменты, что делает проект полноценным фронтендом и бэкендом для взаимодействия с современными AI/ML системами.

### 中文

awizemann/scarf：awizemann/scarf helps connect AI assistants to real tools and data through a standard protocol.。适合用于connect AI agents to tools、ship Model Context Protocol servers。Early or unclear: treat as research material until maintenance, releases, docs, and issue activity are verified.

## 🧭 Practical evaluation

**Value:** awizemann/scarf helps connect AI assistants to real tools and data through a standard protocol.
...
<sub>🔭 Discovered 2026-05-08 · [View on GitHub](https://github.com/awizemann/scarf) · [← Back to Mcp](./README.md)</sub>
